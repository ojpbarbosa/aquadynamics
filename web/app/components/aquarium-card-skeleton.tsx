export default function AquariumCardSkeleton() {
  return (
    <div className="h-60 sm:h-64 rounded dark:text-neutral-100/80 animate-pulse text-neutral-900 border justify-between border-gray-300 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-800/30 flex flex-col items-start">
      <div className="w-full h-40 flex items-center justify-center bg-neutral-300/20 text-neutral-500 dark:text-neutral-500 dark:bg-neutral-800/30 flex-col gap-y-2" />
